...
class DriverLicense(models.Model):
    ...
    driver_license_front = models.ImageField(upload_to=driver_license_image_upload_path)
    driver_license_back = models.ImageField(upload_to=driver_license_image_upload_path)
    motorcycle_registration_certificate_front = models.ImageField(upload_to=registration_certificate_image_upload_path)
    motorcycle_registration_certificate_back = models.ImageField(upload_to=registration_certificate_image_upload_path)
