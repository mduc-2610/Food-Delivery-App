...
class PostLike(BaseLike):
    ...
    post = models.ForeignKey("social.Post", related_name="post_likes", on_delete=models.CASCADE)
...
class CommentLike(BaseLike):
    ...
    comment = models.ForeignKey("social.Comment", related_name="comment_likes", on_delete=models.CASCADE)
